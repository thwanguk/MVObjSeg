...
public:
	...
	virtual bool loadCVImage(const Mat& imMat);
#ifndef _MATLAB
...
template <class T>
bool Image<T>::loadCVImage(const Mat& imMat)
{
	...
	//pData = (T*)imMat.data;
	pData = new T [imWidth*imHeight*nChannels];
	memcpy(pData, imMat.data, imWidth*imHeight*nChannels*sizeof(T));
